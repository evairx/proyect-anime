...
export const getStaticProps = async (context) => {
    ...
    const res = await axios.get(`http://localhost:3000/api/animes/${id}`);
    const data = res.data;
...
const home = css`
  ...
  min-height: 80vh;
  background: linear-gradient(rgba(195, 0, 255, 0.24) 0%, rgb(40, 4, 41) 90%), url(${anime.backdrop}) no-repeat;
